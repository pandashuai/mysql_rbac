...
module.exports = function(param) {
    ...
    // 配置数据库参数
    _this.mysql = mysql(_this.default.mysql, _this.default.rabc);
    ...
    return function(req, res, next) {
        ...
        // 检测是否处于登录状态
        if (!req.session[_this.default.rabc.user_key]) {
            req[_this.default.hook.root] = function() {
                req.session[_this.default.hook.rabc_route] = [];
                return false;
            }
            return next();
        }
        ...
        req[_this.default.hook.root] = function(callbask) {
            ...
            if (req.session[_this.default.hook.rabc_route] && _this.default.rabc.rabc_type == 1) {
                if (req.session[_this.default.hook.rabc_route].indexOf(path) != '-1') {
            ...
            // 从数据库获取路由数组
            _this.mysql.onlyRoot(req.session[_this.default.rabc.user_key]).then(function(data) {
                req.session[_this.default.hook.rabc_route] = data;
